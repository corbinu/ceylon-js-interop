import com.openswimsoftware.ceylon.js.dom { Element, Event }
import com.openswimsoftware.ceylon.js.language { JSString, JSFunction, JSObject, JSNumber, JSArray, JSObjectAbs, createJSObject, objectDefineProperty, createJSString, DataDescriptor }
