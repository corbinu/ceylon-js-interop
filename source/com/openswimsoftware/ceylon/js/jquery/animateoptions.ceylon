import com.openswimsoftware.ceylon.js.language { JSObject, createJSObject, createJSString, objectDefineProperty, DataDescriptor }

doc("options for creating an jQuery animations")
shared class AnimateOptions(shared String|Integer? duration = null, shared String? easing = null,
	...
	doc("convert the options to a native object")
