...
shared abstract class DOMImplementationAbs() extends JSObjectAbs() {
    ...
    doc("returns a new DocumentType")
    ...
    doc("returns if the DOM has the given feature at the specified or greater version")
